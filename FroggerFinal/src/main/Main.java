...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws IOException {
		...
		// 25, 25, 3);
		// Obstacle obstacle1 = new Obstacle("file:src/resources/truck2Right.png",
		// 100, 100,2 );
		// Obstacle obstacle2 = new
		// Obstacle("file:src/resources/truck1Right.png",0, 150, 1);
		...
		// background.add(new Log("file:src/resources/log2.png", 200, 100, 1));
		// background.add(new Log("file:src/resources/log2.png", 0, 100, 1));
		// background.add(new Log("file:src/resources/log2.png", 100, 120, -1));
		// background.add(new Log("file:src/resources/log2.png", 200, 120, -1));
		// background.add(new Log("file:src/resources/log2.png", 100, 140, 1));
		// background.add(new Log("file:src/resources/log2.png", 200, 140, 1));
		// background.add(new Log("file:src/resources/log2.png", 100, 160, -1));
		// background.add(new Log("file:src/resources/log2.png", 300, 160, -1));
		// background.add(new Log("file:src/resources/log2.png", 100, 180, 1));
		// background.add(new Log("file:src/resources/log2.png", 200, 180, 1));
		// background.add(new Log("file:src/resources/log2.png", 100, 200, -1));
		// background.add(new Log("file:src/resources/log2.png", 200, 200, -1));
		// background.add(new Log("file:src/resources/log2.png", 100, 220, 1));
		// background.add(new Log("file:src/resources/log2.png", 200, 220, 1));
		// background.add(new Log("file:src/resources/log2.png", 400, 220, 1));
		// End end2 = new End();
		// End end3 = new End();
		// End end4 = new End();
		// End end5 = new End();
		...
		// background.add(new Obstacle("file:src/resources/truck1"+"Right.png",
		// 720, 649, 1, 120, 120));
